        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products/eyeglasses" className="text-gray-300 hover:text-white">Eyeglasses</Link>
              </li>
              <li>
                <Link to="/products/sunglasses" className="text-gray-300 hover:text-white">Sunglasses</Link>
              </li>
              <li>
                <Link to="/products/contact-lenses" className="text-gray-300 hover:text-white">Contact Lenses</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/pharmacies" className="text-gray-300 hover:text-white">Partner Pharmacies</Link>
              </li>
              <li>
                <Link to="/delivery" className="text-gray-300 hover:text-white">Delivery Info</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">
                <a href="tel:+250780000000" className="hover:text-white">+250 780 000 000</a>
              </li>
              <li className="text-gray-300">
                <a href="mailto:info@eyewear-rwanda.com" className="hover:text-white">info@eyewear-rwanda.com</a>
              </li>
              <li>
